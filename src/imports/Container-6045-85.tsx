import svgPaths from "./svg-gqbnohv6wf";
...
function Frame() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[30px] not-italic relative shrink-0 text-[#1d1e20] text-[24px] text-center text-nowrap">Save time with AI</p>
    </div>
  );
}
