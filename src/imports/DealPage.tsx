import svgPaths from "./svg-fzovcnss1q";
...
import { imgIStock51422918631 } from "./svg-s2f6m";
...
function SetUp() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="SetUp">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_1_11610)" id="SetUp">
          <path d={svgPaths.pf42dda0} fill="var(--fill-0, #72777E)" id="Shape" />
        </g>
        <defs>
          <clipPath id="clip0_1_11610">
            <rect fill="white" height="14" width="14" />
          </clipPath>
        </defs>
      </svg>
...
function Plus() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_1_11555)" id="Plus">
...
function Dots() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Dots">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g clipPath="url(#clip0_1_11522)" id="Dots">
          <g id="Shape">
...
function BuildingsMultiple() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="BuildingsMultiple">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_11490)" id="BuildingsMultiple">
          <g id="Shape">
...
function Floorplan() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Floorplan">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_11498)" id="Floorplan">
...
function SitePlan() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SitePlan">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_11622)" id="SitePlan">
          <g id="Shape">
