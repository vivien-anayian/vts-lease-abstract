import svgPaths from "./svg-ynn6k3pw1y";
...
function ProposalUploadBox() {
  return (
    <div className="bg-white h-[208px] relative rounded-[16px] shrink-0 w-full" data-name="ProposalUploadBox">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start pb-[2px] pl-[16px] pr-[34px] pt-[26px] relative size-full">
          <Container19 />
        </div>
      </div>
